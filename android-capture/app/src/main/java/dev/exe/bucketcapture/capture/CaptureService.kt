...
class CaptureService : Service() {
    ...
    companion object { const val ACTION_START = "capture.start"; const val ACTION_STOP = "capture.stop"; const val ACTION_SYNC = "capture.sync"; const val CHANNEL = "capture"; const val NOTIFICATION_ID = 1001 }
}

/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f3fd3c33b8cca321f1e37dfedec4548a)
// Runtime types generated with workerd@1.20260825.1 2026-08-25 
interface __BaseEnv_Env {
	ARTIFACTS: R2Bucket;
	STREAM: DurableObjectNamespace<import("./src/index").Stream>;
	DIRECTORY_REFRESH: Workflow<Parameters<import("./src/index").DirectoryRefreshWorkflow['run']>[0]['payload']>;
	INGEST: Workflow<Parameters<import("./src/index").IngestWorkflow['run']>[0]['payload']>;
}

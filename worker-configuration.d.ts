/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6a0f0418fd82841b91d06433e8501a0d)
...
interface __BaseEnv_Env {
	...
	SOURCE_RUN: Workflow<Parameters<import("./server/index").SourceRun['run']>[0]['payload']>;
	PROCESS_INGEST: Workflow<Parameters<import("./server/index").ProcessIngest['run']>[0]['payload']>;

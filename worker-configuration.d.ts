/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7ec7e0ff8347baff5ace885c64494e73)
...
interface __BaseEnv_Env {
	...
	GDRIVE_FOLDER_ID: "1jPV5VAlHuU-9FtGewJZPqDM5ekoKgG5q";
	STREAM: DurableObjectNamespace<import("./server/index").Stream>;
	SOURCE_REFRESH: Workflow<Parameters<import("./server/index").SourceRefresh['run']>[0]['payload']>;
	SOURCE_INGEST: Workflow<Parameters<import("./server/index").SourceIngest['run']>[0]['payload']>;
	ASSEMBLYAI_TRANSCRIPT: Workflow<Parameters<import("./server/index").AssemblyAITranscript['run']>[0]['payload']>;
	JOURNAL: Workflow<Parameters<import("./server/index").Journal['run']>[0]['payload']>;
	TRIAGE: Workflow<Parameters<import("./server/index").Triage['run']>[0]['payload']>;
	ROOT: Workflow<Parameters<import("./server/index").Root['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GOOGLE_TOKEN_URL" | "ASSEMBLYAI_API_URL" | "GDRIVE_FOLDER_ID">> {}
}

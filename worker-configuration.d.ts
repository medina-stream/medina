/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5cf586aa9fe90c1cf549ac25607ea245)
...
interface __BaseEnv_Env {
	...
	GDRIVE_SOURCE: Workflow<Parameters<import("./server/index").GdriveSource['run']>[0]['payload']>;
	GDRIVE_INGEST: Workflow<Parameters<import("./server/index").GdriveIngest['run']>[0]['payload']>;
